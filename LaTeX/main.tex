...
% jednotlivé kapitoly
\include{tex/1-uvod}
\include{tex/2-reserse}
\include{tex/3-teorie-casove-rady}
\include{tex/4-teorie-drahy-druzic}
\include{tex/5-implementace}
\include{tex/6-testovani}
\include{tex/7-vysledky}
\include{tex/8-zaver}
